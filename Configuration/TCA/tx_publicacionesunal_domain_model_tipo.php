...
return [
    'ctrl' => [
        ...
        'searchFields' => 'nombre,nombre_display,publicaciones',
        'iconfile' => 'EXT:publicaciones_unal/Resources/Public/Icons/tx_publicacionesunal_domain_model_tipo.gif'
    ],
    'interface' => [
        'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, nombre, nombre_display, publicaciones',
    ],
    'types' => [
        '1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, nombre, nombre_display, publicaciones, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
        'sys_language_uid' => [
            'exclude' => true,
        ...
        'publicaciones' => [
            'exclude' => true,
            'label' => 'LLL:EXT:publicaciones_unal/Resources/Private/Language/locallang_db.xlf:tx_publicacionesunal_domain_model_tipo.publicaciones',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectMultipleSideBySide',
                'foreign_table' => 'tx_publicacionesunal_domain_model_publicacion',
                'MM' => 'tx_publicacionesunal_tipo_publicacion_mm',
                'size' => 10,
                'autoSizeMax' => 30,
                'maxitems' => 9999,
                'multiple' => 0,
                'wizards' => [
                    ...
                    'add' => [
                        ...
                        'params' => [
                            'table' => 'tx_publicacionesunal_domain_model_publicacion',
                            'pid' => '###CURRENT_PID###',
                            'setValue' => 'prepend'
                        ],
                    ],
